        ...
        <div className="pb-80 pt-16 sm:pb-40 sm:pt-24 lg:pb-48 lg:pt-40">
          <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
            <div className="sm:max-w-lg">
              ...
              Brilhe como nunca antes
              </h1>
              <p className="mt-4 text-xl text-gray-500">
              Descubra a coleção que transforma cada momento em algo extraordinário.
              Nossas semijoias foram criadas para destacar sua beleza e elevar o seu estilo com sofisticação e delicadeza.
              </p>
            </div>
            <div>
              <div className="mt-10">
